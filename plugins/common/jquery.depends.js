...
(function (c) {
    ...
    d.prototype.values = function (f) {
        var j = this.$dependencyObj.val(), h = f.length, g = 0, e = false;
    ...
    d.prototype.not = function (e) {
        var h = this.$dependencyObj.val(), g = e.length, f = 0;
        for (f; f < g; f += 1) {
            if (e[f] === h) {
                return false
            }
    ...
    d.prototype.match = function (e) {
        var g = this.$dependencyObj.val(), f = e;
        return f.test(g)
    };
    d.prototype.contains = function (e) {
        var g = this.$dependencyObj.val(), f = 0;
    ...
    a.prototype.doesQualify = function () {
        var f = this.dependencies.length, g = 0, e = true;
        for (g; g < f; g += 1) {
    ...
    var b = function (e, g, f) {
        ...
        this.settings = c.extend({
            disable: true, hide: true, duration: 200, onEnable: function () {
            }, onDisable: function () {
            }
        }, f);
    ...
    b.prototype.enable = function (e) {
        var h = this.$subject, g = this.$subject.attr("id"), f;
    ...
    b.prototype.check = function (h) {
        var g = this.dependencySets.length, f = 0, e = false;
        for (f; f < g; f += 1) {
