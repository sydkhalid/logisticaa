        ...
        <div class="card-body">
          <div class="v2-card-heading mb-3">
            ...
            <div>
              ...
              <p class="card-description mb-0">Create a fresh LR record and sync the current vehicle location to BOCSH.</p>
            </div>
          </div>
          ...
          <form method="POST" action="{{ $formAction }}" class="forms-sample" id="lr-form">
            ...
            <div class="d-flex justify-content-end gap-2">
              ...
              <button type="submit" class="btn btn-primary btn-icon-text" id="lr-submit">
                <i class="mdi mdi-content-save-outline"></i>
                <span>Create LR Tracking</span>
              </button>
            </div>
          </form>
        </div>
