        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{ url('vehicle') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input value="" type="text" id="vehicleNo" name ="vehicleNo" class="form-control" placeholder="Vehicle Number">
                                </div>
                            </div>
                            <div class="col-md-12 ">
