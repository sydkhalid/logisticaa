                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $vehicle_details['driverName'] }}"  class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $vehicle_details['vehicleId'] }}"  class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $vehicle_details['vehicleTypeValue'] }}"  class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Ignition</label>
                                    <input value="{{ $vehicle_details['status'] }}"  class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Address</label>
                                    <textarea  class="form-control" readonly>{{ $vehicle_details['address'] }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
